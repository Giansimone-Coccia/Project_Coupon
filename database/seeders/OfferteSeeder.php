...
class OfferteSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('offerte')->insert([ //tempoFruizione espresso in num di settimane
            ...
            ['codOfferta' => 'O0004', 'oggettoOff' => 'Coupon 10% da applicare sul saldo finale abbigliamento', 'modalita' => 'Online', 'tempoFruiz' => '4', 'luogoFruiz' => 'Roma', 'nomeOff' => '20%', 'logoOff' => 'Adidas-abbigliamento.png','azienda' => 'A0003', 'utente' => 'US0004'],
