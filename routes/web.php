...
Route::get('/mostra_aziende_area_personale', [PublicController::class, 'allAziendeAdmin'])
        ->name('mostra_aziende_area_personale')->middleware('can:isStaffOrAdmin');

Route::get('/mostra_aziende_area_personale/mostra_offerte_area_personale/{aziendaId}', [PublicController::class, 'getOfferteAdmin'])
...
Route::get('/area_personale_utente/modifica_profilo_utente', [UtenteController::class, 'viewModProfUtente'])
        ->name('modifica_profilo_utente')->middleware('can:isUser');

Route::post('/area_personale_utente/modifica_profilo_utente', [UtenteController::class, 'modificaProfiloUtente'])
        ->name('modifica_profilo_utente.store')->middleware('can:isUser');
...
Route::get('/area_personale_admin/crea_azienda', [PublicController::class, 'addAzienda'])
        ->name('crea_azienda')->middleware('can:isAdmin');

Route::post('/area_personale_admin/mostra_aziende_area_personale/crea_azienda', [PublicController::class, 'storeAzienda'])
...
Route::get('/area_personale_admin/crea_faq', [DomandeController::class, 'addFaq'])
        ->name('crea_faq')->middleware('can:isAdmin');

Route::post('/area_personale_admin/crea_faq', [DomandeController::class, 'storeFaq'])
...
Route::get('/area_personale_admin/crea_membro_staff', [UtenteController::class, 'addMembroStaff'])
        ->name('crea_membro_staff')->middleware('can:isAdmin');

Route::post('/area_personale_admin/crea_membro_staff', [UtenteController::class, 'storeMembroStaff'])
...
Route::post('/area_personale_admin/mostra_utenti_registrati/elimina_utenti_registrati/{userId}', [UtenteController::class, 'eliminaUserRegistered'])
        ->name('elimina_utenti_registrati.store')->middleware('can:isAdmin');

Route::get('/mostra_aziende_area_personale/modifica_azienda/{codiceA}', [PublicController::class, 'viewAzienda'])
        ->name('modifica_azienda')->middleware('can:isAdmin');

Route::post('/mostra_aziende_area_personale/modifica_azienda/{codiceA}', [PublicController::class, 'modificaAzienda'])
...
Route::get('/mostra_aziende_area_personale/mostra_offerte_area_personale/modifica_offerta/{offertaId}', [PublicController::class, 'viewOfferta'])
        ->name('modifica_offerta')->middleware('can:isStaff');

Route::post('/mostra_aziende_area_personale/mostra_offerte_area_personale/modifica_offerta/{offertaId}', [PublicController::class, 'modificaOfferta'])
        ->name('modifica_offerta.store')->middleware('can:isStaff');

Route::post('/mostra_aziende_area_personale/mostra_offerte_area_personale/elimina_offerta/{offertaId}', [PublicController::class, 'eliminaOfferta'])
