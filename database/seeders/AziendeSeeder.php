    ...
    public function run()
    {
        ...
        DB::table('aziende')->insert([
            ...
            ['codiceA' => "A0002", 'nome' => "Nike", 'localizzazione' => "Via emilia,88 ROMA",
                'ragSoc' => "SRL", 'image' => 'nike.png', 'tipologia' => "abbigliamento", 'descAzienda' => 'Nike, Inc. è una multinazionale statunitense che produce calzature, abbigliamento e accessori sportivi.','utente' => "US0005"],
            ...
            ['codiceA' => "A0004", 'nome' => "Si con te", 'localizzazione' => "Via bartolo, 5 ANCONA",
                'ragSoc' => "SPA", 'image' => 'Si_con_te.png', 'tipologia' => "alimentare", 'descAzienda' => 'Si con te è il tuo supermercato Ancona e provincia di fiducia, prodotti sempre freschi con un grande assortimento e offerte ogni giorno.','utente' => "US0002"],
