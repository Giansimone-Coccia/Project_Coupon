    ...
    public function run() {
        DB::table('users')->insert([
            ...
            ['username' => 'UC0005', 'password' => Hash::make('twebexam4'), 'nome' => 'Edoardo', 'cognome' => 'Giusti', 'genere' => 'M', 'dataNascita' => '1999-07-03', 'email' => 'edoardog1@gmail.com', 'telefono' => '3001234567', 'ruolo' => 'user', 'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s")],
            ['username' => 'US0001', 'password' => Hash::make('abdce'), 'nome' => 'Luca', 'cognome' => 'Traini', 'genere' => null, 'dataNascita' => null, 'email' => null, 'telefono' => null, 'ruolo' => 'staff', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
            ['username' => 'US0002', 'password' => Hash::make('ddddd'), 'nome' => 'Franca', 'cognome' => 'Marchi', 'genere' => null, 'dataNascita' => null, 'email' => null, 'telefono' => null, 'ruolo' => 'staff', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
            ['username' => 'US0003', 'password' => Hash::make('eeeee'), 'nome' => 'Alessio', 'cognome' => 'Romagnoli', 'genere' => null, 'dataNascita' => null, 'email' => null, 'telefono' => null, 'ruolo' => 'staff', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
            ['username' => 'US0004', 'password' => Hash::make('fffff'), 'nome' => 'Luigi', 'cognome' => 'Verdi', 'genere' => null, 'dataNascita' => null, 'email' => null, 'telefono' => null, 'ruolo' => 'staff', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
            ['username' => 'US0005', 'password' => Hash::make('aaaaa'), 'nome' => 'Edoardo', 'cognome' => 'Giusti', 'genere' => null, 'dataNascita' => null, 'email' => null, 'telefono' => null, 'ruolo' => 'staff', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
