    ...
    public function run()
    {
        DB::table('users')->insert([
            ...
            ['username' => 'UC0005', 'password' => Hash::make('twebexam4'), 'nome' => 'Edoardo', 'cognome' => 'Giusti', 'genere' =>'M' , 'dataNascita' => '1999-07-03','email' => 'edoardog1@gmail.com', 'telefono' => '3001234567','ruolo' =>'user','created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s")],
            ['username' => 'US0001', 'password' => Hash::make('abdce'), 'nome' => 'Luca', 'cognome' => 'Traini', 'genere' =>'M' , 'dataNascita' => '1996-11-11','email' => "lucatorelli@gmail.com", 'telefono' => "3333333333",'ruolo' =>'user','created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s")],
            ['username' => 'US0002', 'password' => Hash::make('ddddd'), 'nome' => 'Franca', 'cognome' => 'Marchi', 'genere' =>'F' , 'dataNascita' => '1990-02-25','email' => "francamarchi@outlook.it", 'telefono' => "3200232443",'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"), 'ruolo' =>'staff'],
